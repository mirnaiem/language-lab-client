 ...
 return (
  <div>
    <Swiper
      ...
      >
        <SwiperSlide>
         <div className='bg-[#fff1e7] flex justify-evenly py-24 items-center'>
          <div className='w-1/3 space-y-6'>
           <h2 className='text-4xl font-bold'>Discover the World through <span className='text-orange-500'> Language Lab</span></h2>
        ...
        <SwiperSlide>
         <div className='bg-[#fff1e7] flex justify-evenly py-24 items-center'>
          <div className='w-1/3 space-y-6'>
           <h2 className='text-4xl font-bold'>Unlock Your Language Potential with <br /><span className='text-emerald-700'>Expert Guidance </span></h2>
        ...
        <SwiperSlide>
         <div className='bg-[#fff1e7] flex justify-evenly py-24 items-center'>
          <div className='w-1/3 space-y-6'>
           <h2 className='text-4xl font-bold'>Immerse Yourself in Language and Culture<span className='text-orange-500'> Language Lab</span></h2>
