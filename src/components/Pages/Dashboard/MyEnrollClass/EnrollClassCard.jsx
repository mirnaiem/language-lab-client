...
const EnrollClassCard = ({enroll}) => {
 ...
 return (
  ...
  <figure><img className=' w-80 h-full' src={classImage} alt="Movie"/></figure>
  <div className="card-body">
    <h2 className="card-title">CLass Name: <span className='text-xl font-bold'>{className}</span></h2>
    <h2 className="card-title">Instructor Name: <span className='text-lg font-bold text-gray-500'>{instructorName}</span></h2>
