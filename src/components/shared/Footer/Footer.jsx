...
const Footer = () => {
 return (
  ...
  <div>
    ...
    <p>Language Lab School<br/>Develop Your Own Language Skill</p>
  </div> 
  <div>
...
<div className="divider my-0 w-4/5 mx-auto"></div>
  
<footer className="footer items-center justify-center p-4 ">
<div className="items-center   grid-flow-col">
    <p>Copyright © 2023 - All right reserved</p>
  </div> 
  <div className="grid-flow-col invisible md:visible gap-4 md:place-self-center md:justify-self-end">
